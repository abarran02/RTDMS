...
description: "This repo contains code for a web application, which can read temperature and pressure data from IoT Hub and show the real-time data on a web page."
---

# web-apps-node-iot-hub-data-visualization

This repo contains code for a web application, which can read temperature and pressure data from IoT Hub and show the real-time data in a line chart on the web page.
...
- If you have a physical Raspberry Pi and BMP280 sensor, you may measure and report real temperature and pressure values by following the [Connect Raspberry Pi to Azure IoT Hub (Node.js)](https://docs.microsoft.com/en-us/azure/iot-hub/iot-hub-raspberry-pi-kit-node-get-started) tutorial.
